---
name: fix-dart
description: DART 기업 조회, 재무분석 화면, XBRL 파싱 버그를 진단·수정한다. 기업 검색 실패, XBRL 전체 null(분기보고서 연도 불일치), 현금·재고·당좌자산 N/A, 전년도 매출 미입력, IFRS 대기업 인건비 N/A, DART 조회 실패 후 수동입력 안 됨 등에 사용.
---
