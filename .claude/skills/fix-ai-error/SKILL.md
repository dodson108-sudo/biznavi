---
name: fix-ai-error
description: "AI 분석 시작" 버튼 클릭 후 발생하는 오류를 단계별로 진단·수정한다. 로딩 중 504 타임아웃, "API 호출 실패", "JSON 파싱 실패" 팝업, stop_reason=max_tokens로 인한 JSON 절단 등 AI 분석 호출/응답 단계 오류에 사용.
---

# AI 분석 버튼 클릭 시 오류 진단·수정
