...
const DiagCommon = (() => {
  ...
  const ITEMS = {
    ...
    '2_1': { label: '온라인 기업 정보 정합성', question: '홈페이지·검색 포털·업종 디렉터리 등 고객이 우리를 찾는 온라인 접점에 상호·주소·연락처가 일치하며 타겟 키워드가 포함되어 있습니까?', guide: '기업 정보 불일치는 검색 알고리즘 패널티 유발 · 예: 외식·소매는 네이버 플레이스·카카오맵, B2B 제조·수출은 홈페이지·기업정보 디렉터리·구글 비즈니스', scale: [{ score:1, desc:'온라인 접점이 없거나 채널 간 기업 정보 불일치율 50% 이상.' },{ score:2, desc:'등록은 완료했으나 채널별 상호·주소·연락처가 서로 다름.' },{ score:3, desc:'주요 채널 기업 정보 일치. 기본 키워드 타겟팅.' },{ score:4, desc:'다채널 정보 동기화 + 검색엔진 구조화 데이터(Schema) 적용.' },{ score:5, desc:'API 기반 실시간 동기화 + 자동 크롤링 감시.' }], ai_trigger:{ threshold:2, warning:'nap_mismatch' } },
    ...
    '2_3': { label: '고객 만족도·평판 관리', question: '고객 평가와 불만을 실시간으로 파악하며 정해진 시간(48시간) 안에 대응하고 긍정 평가를 자연스럽게 축적하는 체계가 작동하고 있습니까?', guide: '예: 소매·외식은 플랫폼 리뷰·답글·평점 4.0 관리, B2B 제조는 거래처 만족도·품질 클레임 대응 리드타임, 전문서비스는 상담 후기·재의뢰율', scale: [{ score:1, desc:'고객 평가를 확인하지 않음. 부정 평가 방치.' },{ score:2, desc:'불만이 접수될 때만 비정기 대응.' },{ score:3, desc:'응대 기준에 따라 실시간 대응. 만족도 수준 유지.' },{ score:4, desc:'거래·이용 완료 시점과 연동한 자동 평가 수집 가동.' },{ score:5, desc:'평가 데이터 분석 + 평판 리스크 조기 경보 체계 운영.' }], ai_trigger:{ threshold:2, warning:'reputation_risk' } },
    ...
    '5_2': { label: '폐기물·자원 순환 관리 (E)', question: '공정·영업 과정에서 발생하는 폐기물과 원부자재 손실의 단가 가치를 계산하고 감축 목표를 설정·추적하고 있습니까?', guide: '폐기물 증가 = 공정 효율 저하 + 마진 축소 직접 신호 · 예: 외식업은 식재료 로스, 제조업은 불량·스크랩, 유통은 파손·반품, 서비스업은 소모품·인쇄물', scale: [{ score:1, desc:'폐기물 관리 기준 없음. 무단 배출.' },{ score:2, desc:'폐기 비용 사후 정산. 원인 공정 식별 불가.' },{ score:3, desc:'원부자재 손실 추적 분석. 개선 목표 정의.' },{ score:4, desc:'폐기물 1kg 감축당 ACM 개선 현업 적용.' },{ score:5, desc:'제로 웨이스트 순환 공정. 폐기 90% 차단.' }], ai_trigger:{ threshold:2, warning:'waste_unmanaged' } },
