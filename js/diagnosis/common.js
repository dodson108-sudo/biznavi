const COMMON_DIAGNOSIS = {
  ...
  areas: [
    ...
    },
    {
      ...
      items: [
        { id: "5_1", text: "경쟁사 대비 핵심 차별화 요소", min: "없음·불명확", max: "독보적 우위" },
        { id: "5_2", text: "고객이 우리를 선택하는 명확한 이유", min: "모름·불분명", max: "명확히 설명 가능" },
        { id: "5_3", text: "핵심 역량의 모방 난이도", min: "누구나 가능", max: "기술·특허·관계로 보호" },
        { id: "5_4", text: "가격 이외 경쟁 수단 보유", min: "가격만으로 경쟁", max: "다양한 비가격 강점" }
      ]
    }
  ],
  scoreGuide: {
