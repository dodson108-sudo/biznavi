...
const DiagVenture = (() => {
  ...
  const DOMAINS = [
    ...
    { id:'v5', key:'funding',      label:'투자유치·자금조달',   icon:'💵', desc:'투자 이력·투자 설명 자료(IR)·기술보증 검토·자금 소요 계획을 진단합니다.',              weight:0.125 },
  ...
  const ITEMS = {
    ...
    'v1_4': {
      ...
      scale: [
        ...
        { score:3, desc:'차별점을 말로는 설명하나 제안서·투자 설명 자료(IR)에는 담겨 있지 않음.' },
    ...
    'v2_5': {
      label: '측정 프레임워크 적용',
      question: '사회적 성과를 재는 표준 방식(IMP·SROI 등)을 적용해 본 적이 있는가? — ※ IMP(Impact Management Project) = 임팩트를 5개 축으로 정리하는 국제 기준, SROI(Social Return on Investment) = 투입 대비 사회적 성과를 금액으로 환산하는 방법',
      scale: [
        ...
        { score:5, desc:'표준 방식을 정기 적용하며 결과를 투자 설명 자료(IR)와 성과 보고에 활용함.' },
      ],
    ...
    'v4_1': {
      ...
      scale: [
        ...
        { score:5, desc:'산출 결과를 투자 설명 자료(IR)에 반영하고 가정이 바뀌면 갱신하고 있음.' },
      ],
    ...
    'v4_2': {
      ...
      scale: [
        ...
        { score:5, desc:'핵심 성장 지표를 정해 목표 대비로 관리하며 투자 설명 자료(IR)에 그대로 쓸 수 있음.' },
      ],
    ...
    'v4_5': {
      ...
      scale: [
        ...
        { score:5, desc:'가격·성능·고객군 축으로 위치를 정리하고 투자 설명 자료(IR)에 담고 있음.' },
      ],
