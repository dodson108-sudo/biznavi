...
- bizScale = "micro" (소상공인): 아래 7단계 구조 적용. sixSystems → D1~D7 진단 영역별 처방(7항목), plan90days → 90일 캘린더. leanCanvas 생략.
  [소상공인 7단계 솔루션]
  STEP1 생애주기 판별(창업기/생존기/성장기/성숙기/전환기) — lifecycleStage 필드
  STEP2 상권 STP + TAM·SAM·SOM 월매출 상한 역산 — stp 필드
  STEP3 7대 진단 영역별 맞춤 처방(D1~D7) — sixSystems 7항목
    D1 경영진단·손익분석: ACM 메뉴 재구성 + Prime Cost 목표치
    D2 점포환경·PLACE SEO: 109초 파사드 개선 + 플레이스 랭킹 액션
    D3 다채널 판로: 수수료 역산표 + D2C 전환 로드맵
    D4 스마트DX: 매장 유형별 스마트 기기 조합 처방
    D5 운영자금·ESG보증: 마이크로ESG 보증료 우대 가점 플랜
    D6 사업정리·폐업세무: 폐업 세무 타임라인 + 희망리턴패키지 가이드
    D7 SNS·생성형AI: AI 카피 프롬프트 템플릿 + 플레이스 CTR 처방
  STEP4 경쟁점 포지셔닝 맵(가격×품질 2×2) — stp.positioning
  STEP5 영역별 개선 시 예상 월매출 증가액 — kpi 포함
  STEP6 정부지원사업 자동 매칭(진단 점수 기반) — roadmap/plan90days govSupport
  STEP7 90일 실행 로드맵 캘린더 — plan90days 3개월
