...
| 3 | 나머지 5문항 `5_3`·`6_3`·`2_3`·`2_4`·`4_2` | 예정 |
...
### ⑧ 캐시버스팅
`index.html` 로컬 `?v=` **52곳** 전부 `20260818x`

### ⑨ 남은 이슈
1. **3단계 미완** — `5_3`·`6_3`·`2_3`·`2_4`·`4_2`. ⚠ **`5_3`이 `solo_pt`에서 가장 중요하다**
   (주휴수당·4대보험·근로계약서 당일 교부를 단시간 근로자 기준으로)
