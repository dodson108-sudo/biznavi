...
- **브랜치**: `main` (단일 브랜치 운영)
- **캐시버스팅**: `index.html`의 로컬 `?v=` **53곳**(외부 CDN 제외). 현재 `20260922a`
...
### sme PPT (1단계 색 체계·표지·띠 2026-09-21 / 2단계 차트·시각화 2026-09-22 완료)
...
- ⚠ **넘침 처리·분량(칸별 3개·KPI 5장·90일 3개월 상한)은 3단계**에서 한다.
